...
--------------------
ENT.Model = {
	"models/vj_base/gibs/alien/gib_small1.mdl",
	"models/vj_base/gibs/alien/gib_small2.mdl",
	"models/vj_base/gibs/alien/gib_small3.mdl"
}
ENT.ProjectileType = VJ.PROJ_TYPE_GRAVITY
ENT.CollisionDecal = "YellowBlood"
ENT.DoesDirectDamage = true
ENT.DirectDamage = 7
ENT.DirectDamageType = bit.bor(DMG_CLUB, DMG_ACID)
...
--------------------
function ENT:Init()
	ParticleEffect("blood_impact_yellow_01", self:GetPos(), self:GetAngles(), self)
	...
	if self.BBoHG_Flesh_Burning then
		self:Ignite(10)
		self.DirectDamageType = bit.bor(DMG_CLUB, DMG_ACID, DMG_BURN)
	end
end
--------------------
